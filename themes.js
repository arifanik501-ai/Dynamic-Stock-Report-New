...
const themes = [
    ...
    // ─── SUPER PREMIUM UNIQUE (DARK) ───
    { name: "Black Diamond",     bg: '#050507', primary: '#1a1a2e', accent: '#d4af37', text: '#fefce8', glow: 'rgba(212, 175, 55, 0.22)', mode: 'dark' },
    { name: "Royal Velvet",      bg: '#0a0612', primary: '#2e1065', accent: '#c4b5fd', text: '#ede9fe', glow: 'rgba(196, 181, 253, 0.20)', mode: 'dark' },
    { name: "Imperial Jade",     bg: '#04120e', primary: '#064e3b', accent: '#6ee7b7', text: '#d1fae5', glow: 'rgba(110, 231, 183, 0.20)', mode: 'dark' },
    { name: "Sapphire Crown",    bg: '#050a1a', primary: '#1e2a78', accent: '#93c5fd', text: '#dbeafe', glow: 'rgba(147, 197, 253, 0.20)', mode: 'dark' },
    { name: "Crimson Throne",    bg: '#14060a', primary: '#4c0519', accent: '#fb7185', text: '#ffe4e6', glow: 'rgba(251, 113, 133, 0.20)', mode: 'dark' },
    { name: "Onyx Pearl",        bg: '#06070a', primary: '#18181b', accent: '#f5f5f4', text: '#fafafa', glow: 'rgba(245, 245, 244, 0.10)', mode: 'dark' },
    { name: "Tigers Eye",        bg: '#14100a', primary: '#5c2d0a', accent: '#facc15', text: '#fef9c3', glow: 'rgba(250, 204, 21, 0.22)', mode: 'dark' },
    { name: "Midnight Sapphire", bg: '#04081a', primary: '#0c1e3f', accent: '#38bdf8', text: '#e0f2fe', glow: 'rgba(56, 189, 248, 0.22)', mode: 'dark' },
    { name: "Obsidian Rose",     bg: '#10060a', primary: '#3f0a18', accent: '#f9a8d4', text: '#fce7f3', glow: 'rgba(249, 168, 212, 0.20)', mode: 'dark' },
    { name: "Platinum Noir",     bg: '#0a0b0d', primary: '#1f2937', accent: '#e5e7eb', text: '#f9fafb', glow: 'rgba(229, 231, 235, 0.14)', mode: 'dark' },
    { name: "Emerald Royale",    bg: '#03120c', primary: '#022c22', accent: '#34d399', text: '#d1fae5', glow: 'rgba(52, 211, 153, 0.22)', mode: 'dark' },
    { name: "Amethyst Dream",    bg: '#0c0420', primary: '#3b0764', accent: '#d8b4fe', text: '#f3e8ff', glow: 'rgba(216, 180, 254, 0.22)', mode: 'dark' },
    ...
    // ═══════════════════════════════════════════════════
    // ██████  GRADIENT THEMES  ██████  (super premium)
    // ═══════════════════════════════════════════════════

    // ─── DARK GRADIENT ───
    { name: "Aurora Borealis",   bg: '#0a1416', primary: '#0e7490', accent: '#22d3ee', text: '#cffafe', glow: 'rgba(34, 211, 238, 0.24)', mode: 'dark',
      gradient: 'linear-gradient(135deg, #0f2027 0%, #203a43 50%, #2c5364 100%)' },
    { name: "Galactic Sunset",   bg: '#100a1c', primary: '#312e81', accent: '#a78bfa', text: '#ede9fe', glow: 'rgba(167, 139, 250, 0.24)', mode: 'dark',
      gradient: 'linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)' },
    { name: "Royal Purple Haze", bg: '#150825', primary: '#4c1d95', accent: '#c084fc', text: '#f3e8ff', glow: 'rgba(192, 132, 252, 0.24)', mode: 'dark',
      gradient: 'linear-gradient(135deg, #41295a 0%, #2F0743 100%)' },
    { name: "Midnight Aurora",   bg: '#020a18', primary: '#1e3a8a', accent: '#60a5fa', text: '#dbeafe', glow: 'rgba(96, 165, 250, 0.24)', mode: 'dark',
      gradient: 'linear-gradient(135deg, #000428 0%, #004e92 100%)' },
    { name: "Emerald Dream",     bg: '#0a1814', primary: '#134e4a', accent: '#4ade80', text: '#dcfce7', glow: 'rgba(74, 222, 128, 0.22)', mode: 'dark',
      gradient: 'linear-gradient(135deg, #134e5e 0%, #71b280 100%)' },
    { name: "Volcanic Inferno",  bg: '#160806', primary: '#7f1d1d', accent: '#fb923c', text: '#ffedd5', glow: 'rgba(251, 146, 60, 0.24)', mode: 'dark',
      gradient: 'linear-gradient(135deg, #200122 0%, #6F0000 60%, #c2410c 100%)' },
    { name: "Deep Space",        bg: '#040406', primary: '#1f2937', accent: '#9ca3af', text: '#f3f4f6', glow: 'rgba(156, 163, 175, 0.16)', mode: 'dark',
      gradient: 'linear-gradient(135deg, #000000 0%, #232526 60%, #414345 100%)' },
    { name: "Ocean Abyss",       bg: '#04101a', primary: '#0c4a6e', accent: '#0ea5e9', text: '#e0f2fe', glow: 'rgba(14, 165, 233, 0.22)', mode: 'dark',
      gradient: 'linear-gradient(135deg, #02111e 0%, #0a3d62 50%, #0c5275 100%)' },
    { name: "Neon Nebula",       bg: '#100618', primary: '#5b21b6', accent: '#e879f9', text: '#fae8ff', glow: 'rgba(232, 121, 249, 0.26)', mode: 'dark',
      gradient: 'linear-gradient(135deg, #200148 0%, #5b0e91 45%, #9d174d 100%)' },
    { name: "Liquid Mercury",    bg: '#0a0c10', primary: '#1f2937', accent: '#94a3b8', text: '#f1f5f9', glow: 'rgba(148, 163, 184, 0.18)', mode: 'dark',
      gradient: 'linear-gradient(135deg, #1e2a3a 0%, #2c3e50 50%, #4ca1af 100%)' },
    { name: "Phoenix Flame",     bg: '#160806', primary: '#9a3412', accent: '#fde047', text: '#fef9c3', glow: 'rgba(253, 224, 71, 0.26)', mode: 'dark',
      gradient: 'linear-gradient(135deg, #1a0808 0%, #7f1d1d 40%, #b91c1c 70%, #f59e0b 100%)' },
    { name: "Royal Onyx Gold",   bg: '#080608', primary: '#1c1917', accent: '#eab308', text: '#fef9c3', glow: 'rgba(234, 179, 8, 0.26)', mode: 'dark',
      gradient: 'linear-gradient(135deg, #000000 0%, #1c1917 55%, #422006 100%)' },
    { name: "Cyber Dusk",        bg: '#0a0614', primary: '#3b0764', accent: '#22d3ee', text: '#cffafe', glow: 'rgba(34, 211, 238, 0.24)', mode: 'dark',
      gradient: 'linear-gradient(135deg, #1a002b 0%, #1e3a8a 55%, #0e7490 100%)' },
    { name: "Velvet Night",      bg: '#0a0612', primary: '#1e1b4b', accent: '#f472b6', text: '#fce7f3', glow: 'rgba(244, 114, 182, 0.24)', mode: 'dark',
      gradient: 'linear-gradient(135deg, #0f0014 0%, #4a0e6e 60%, #be185d 100%)' },
